...
use usd_gf::{DualQuatd, DualQuatf, DualQuath, Quatd, Quaternion, Quatf, Quath};
...
impl PyQuatd {
    ...
    fn new(args: &pyo3::Bound<'_, pyo3::types::PyTuple>) -> pyo3::PyResult<Self> {
        ...
        if n == 1 {
            ...
            if let Ok(q) = obj.extract::<pyo3::PyRef<'_, PyQuatf>>() {
                ...
                return Ok(Self(Quatd::from_components(
                    q.0.real() as f64,
                    im.x as f64,
                    im.y as f64,
                    im.z as f64,
        ...
        if n == 2 {
            ...
            if let Ok(v) = im_obj.extract::<Vec<f64>>() {
                if v.len() == 3 {
                    return Ok(Self(Quatd::from_components(r, v[0], v[1], v[2])));
                }
            }
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "Quatd: second arg must be Vec3d or [i,j,k]",
            ));
        }
        if n == 4 {
            let r: f64 = args.get_item(0)?.extract()?;
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "Quatd: expected (), (real), (real, Vec3d), or (real, i, j, k)",
        ))
    }
    ...
    fn __mul__(&self, py: Python<'_>, o: &Bound<'_, pyo3::PyAny>) -> PyResult<Py<pyo3::PyAny>> {
        if let Ok(q) = o.extract::<PyRef<'_, Self>>() {
    ...
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, v: f64) {
        self.0.set_real(v);
    }
    #[pyo3(name = "GetImaginary")]
    fn get_imaginary(&self) -> super::vec::PyVec3d {
        super::vec::PyVec3d(*self.0.imaginary())
    }
    #[pyo3(name = "SetImaginary")]
    fn set_imaginary(&mut self, v: &super::vec::PyVec3d) {
    ...
    fn get_normalized(&self, eps: f64) -> Self {
        let mut q = self.0;
        q.normalize_with_eps(eps);
        Self(q)
    }
    #[pyo3(name = "Normalize")]
    #[pyo3(signature = (eps=f64::MIN_POSITIVE))]
    fn normalize(&mut self, eps: f64) -> Self {
        self.0.normalize_with_eps(eps);
        self.clone()
    }
    ...
    #[pyo3(name = "GetConjugate")]
    fn get_conjugate(&self) -> Self {
    ...
    #[setter(real)]
    fn set_real_prop(&mut self, v: f64) {
        self.0.set_real(v);
    }
    #[getter]
    fn imaginary(&self) -> super::vec::PyVec3d {
        super::vec::PyVec3d(*self.0.imaginary())
    }
    #[setter(imaginary)]
    fn set_imaginary_prop(&mut self, v: &super::vec::PyVec3d) {
        self.0.set_imaginary(v.0);
    }
}
...
impl PyQuatf {
    ...
    fn new(args: &pyo3::Bound<'_, pyo3::types::PyTuple>) -> pyo3::PyResult<Self> {
        ...
        if n == 1 {
            ...
            if let Ok(q) = obj.extract::<pyo3::PyRef<'_, PyQuatd>>() {
                let im = q.0.imaginary();
                return Ok(Self(Quatf::from_components(
                    q.0.real() as f32,
                    im.x as f32,
                    im.y as f32,
                    im.z as f32,
        ...
        if n == 2 {
            ...
            if let Ok(v) = im_obj.extract::<Vec<f32>>() {
                if v.len() == 3 {
                    return Ok(Self(Quatf::from_components(r, v[0], v[1], v[2])));
                }
            }
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "Quatf: second arg must be Vec3f or [i,j,k]",
            ));
        }
        if n == 4 {
            let r: f32 = args.get_item(0)?.extract()?;
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "Quatf: expected (), (real), (real, Vec3f), or (real, i, j, k)",
        ))
    }
    ...
    fn __hash__(&self) -> u64 {
        ...
        im.x.to_bits().hash(&mut h);
        im.y.to_bits().hash(&mut h);
        im.z.to_bits().hash(&mut h);
        h.finish()
    }
    fn __neg__(&self) -> Self {
        let im = self.0.imaginary();
    ...
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, v: f32) {
        self.0.set_real(v);
    }
    #[pyo3(name = "GetImaginary")]
    fn get_imaginary(&self) -> super::vec::PyVec3f {
        super::vec::PyVec3f(*self.0.imaginary())
    }
    #[pyo3(name = "SetImaginary")]
    fn set_imaginary(&mut self, v: &super::vec::PyVec3f) {
        self.0.set_imaginary(v.0);
    }
    #[pyo3(name = "GetLength")]
    ...
    fn get_normalized(&self, eps: f32) -> Self {
        let mut q = self.0;
        q.normalize_with_eps(eps);
        Self(q)
    }
    #[pyo3(name = "Normalize")]
    #[pyo3(signature = (eps=f32::MIN_POSITIVE))]
    fn normalize(&mut self, eps: f32) -> Self {
        self.0.normalize_with_eps(eps);
        self.clone()
    }
    #[pyo3(name = "GetInverse")]
    ...
    #[setter(real)]
    fn set_real_prop(&mut self, v: f32) {
        self.0.set_real(v);
    }
    #[getter]
    fn imaginary(&self) -> super::vec::PyVec3f {
        super::vec::PyVec3f(*self.0.imaginary())
    }
    #[setter(imaginary)]
    fn set_imaginary_prop(&mut self, v: &super::vec::PyVec3f) {
        self.0.set_imaginary(v.0);
    }
}
...
impl PyQuath {
    ...
    fn new(args: &pyo3::Bound<'_, pyo3::types::PyTuple>) -> pyo3::PyResult<Self> {
        ...
        if n == 1 {
            ...
            if let Ok(q) = obj.extract::<pyo3::PyRef<'_, PyQuatf>>() {
                let im = q.0.imaginary();
                return Ok(Self(Quath::from_components(
                    Half::from_f32(q.0.real()),
                    Half::from_f32(im.x),
                    Half::from_f32(im.y),
                    Half::from_f32(im.z),
                )));
            ...
            if let Ok(q) = obj.extract::<pyo3::PyRef<'_, PyQuatd>>() {
                let im = q.0.imaginary();
                return Ok(Self(Quath::from_components(
                    Half::from_f32(q.0.real() as f32),
                    Half::from_f32(im.x as f32),
                    Half::from_f32(im.y as f32),
                    Half::from_f32(im.z as f32),
                )));
            }
            let r: f32 = obj.extract()?;
            return Ok(Self(Quath::from_components(
        ...
        if n == 2 {
            ...
            return Err(pyo3::exceptions::PyTypeError::new_err(
                "Quath: second arg must be Vec3h or [i,j,k]",
            ));
        }
        if n == 4 {
            let r: f32 = args.get_item(0)?.extract()?;
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "Quath: expected (), (real), (real, Vec3h), or (real, i, j, k)",
        ))
    }
    ...
    fn __hash__(&self) -> u64 {
        ...
        im.x.bits().hash(&mut h);
        im.y.bits().hash(&mut h);
        im.z.bits().hash(&mut h);
        h.finish()
    }
    ...
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, v: f32) {
        self.0.set_real(Half::from_f32(v));
    }
    #[pyo3(name = "GetLength")]
    fn get_length(&self) -> f32 {
        self.0.length().to_f32()
    }
    #[pyo3(name = "GetNormalized")]
    #[pyo3(signature = (eps=f32::MIN_POSITIVE))]
    fn get_normalized(&self, eps: f32) -> Self {
        let mut q = self.0;
        q.normalize_with_eps(Half::from_f32(eps));
        Self(q)
    }
    #[pyo3(name = "Normalize")]
    #[pyo3(signature = (eps=f32::MIN_POSITIVE))]
    fn normalize(&mut self, eps: f32) -> Self {
        self.0.normalize_with_eps(Half::from_f32(eps));
        self.clone()
    }
    #[pyo3(name = "GetInverse")]
    fn get_inverse(&self) -> Self {
    ...
    #[pyo3(name = "GetImaginary")]
    fn get_imaginary(&self) -> super::vec::PyVec3h {
        super::vec::PyVec3h(*self.0.imaginary())
    }
    #[pyo3(name = "SetImaginary")]
    fn set_imaginary_method(&mut self, v: &super::vec::PyVec3h) {
        self.0.set_imaginary(v.0);
    }
    #[getter]
    fn imaginary(&self) -> super::vec::PyVec3h {
        super::vec::PyVec3h(*self.0.imaginary())
    }
    #[setter(imaginary)]
    fn set_imaginary_prop(&mut self, v: &super::vec::PyVec3h) {
        self.0.set_imaginary(v.0);
    }
    ...
    fn __mul__(&self, py: Python<'_>, o: &Bound<'_, pyo3::PyAny>) -> PyResult<Py<pyo3::PyAny>> {
        ...
        if let Ok(s) = o.extract::<f32>() {
            return Ok(Self(self.0 * Half::from_f32(s))
                .into_pyobject(py)?
                .into_any()
                .unbind());
        }
    ...
    fn __rmul__(&self, s: f32) -> Self {
        Self(self.0 * Half::from_f32(s))
    }
    fn __imul__(slf: Bound<'_, Self>, py: Python<'_>, o: Bound<'_, pyo3::PyAny>) -> PyResult<()> {
        if let Ok(s) = o.extract::<f32>() {
            let l = { slf.borrow().0 };
            slf.borrow_mut().0 = l * Half::from_f32(s);
            return Ok(());
        }
        let rhs = { o.extract::<PyRef<'_, Self>>()?.0 };
        let lhs = { slf.borrow().0 };
...
impl PyQuaternion {
    ...
    fn new(args: &Bound<'_, pyo3::types::PyTuple>) -> pyo3::PyResult<Self> {
        let n = args.len();
        if n == 0 {
            return Ok(Self(Quaternion::new(1.0, usd_gf::vec3::Vec3d::default())));
        }
        if n == 1 {
            let obj = args.get_item(0)?;
        ...
        if n == 2 {
            ...
            if let Ok(v) = im_obj.extract::<Vec<f64>>() {
                if v.len() == 3 {
                    return Ok(Self(Quaternion::new(
                        real,
                        usd_gf::vec3::Vec3d::new(v[0], v[1], v[2]),
                    )));
                }
            }
        }
        if n == 4 {
            ...
            return Ok(Self(Quaternion::new(
                real,
                usd_gf::vec3::Vec3d::new(i, j, k),
            )));
        }
        Err(pyo3::exceptions::PyTypeError::new_err(
            "Quaternion: expected (), (real), (real, Vec3d), (real, [i,j,k]), or (real, i, j, k)",
        ))
    }
    ...
    fn get_normalized(&self, eps: f64) -> Self {
        Self(self.0.normalized(eps))
    }
    #[pyo3(name = "Normalize")]
    #[pyo3(signature = (eps=1e-10))]
    fn normalize(&mut self, eps: f64) -> Self {
        self.0.normalize(eps);
        self.clone()
    }
    #[pyo3(name = "GetInverse")]
    fn get_inverse(&self) -> Self {
        Self(self.0.get_inverse())
    }
    ...
    fn get_conjugate(&self) -> Self {
        ...
        Self(Quaternion::new(
            self.0.real(),
            usd_gf::vec3::Vec3d::new(-im.x, -im.y, -im.z),
        ))
    }
    ...
    fn __mul__(&self, py: Python<'_>, o: &Bound<'_, pyo3::PyAny>) -> PyResult<Py<pyo3::PyAny>> {
        ...
        if let Ok(s) = o.extract::<f64>() {
            ...
            return Ok(Self(Quaternion::new(
                self.0.real() * s,
                usd_gf::vec3::Vec3d::new(im.x * s, im.y * s, im.z * s),
            ))
            .into_pyobject(py)?
            .into_any()
            .unbind());
...
impl PyDualQuatd {
    ...
    fn new(
        real: Option<&Bound<'_, pyo3::PyAny>>,
        dual: Option<&Bound<'_, pyo3::PyAny>>,
    ) -> pyo3::PyResult<Self> {
        let Some(r_obj) = real else {
            return Ok(Self(DualQuatd::identity()));
        };
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "DualQuatd: unsupported constructor",
        ))
    }

    fn __repr__(&self) -> String {
        format!(
            "Gf.DualQuatd(real={}, dual={})",
            self.0.real().real(),
            self.0.dual().real()
        )
    }
    ...
    #[pyo3(name = "GetIdentity")]
    fn get_identity() -> Self {
        Self(DualQuatd::identity())
    }

    #[pyo3(name = "GetReal")]
    fn get_real(&self) -> PyQuatd {
        PyQuatd(*self.0.real())
    }
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, q: &PyQuatd) {
        self.0.set_real(q.0);
    }
    #[pyo3(name = "GetDual")]
    fn get_dual(&self) -> PyQuatd {
        PyQuatd(*self.0.dual())
    }
    #[pyo3(name = "SetDual")]
    fn set_dual(&mut self, q: &PyQuatd) {
        self.0.set_dual(q.0);
    }
    // DualQuat::length() returns (T, T) — real and dual parts of the length
    #[pyo3(name = "GetLength")]
    fn get_length(&self) -> (f64, f64) {
        self.0.length()
    }
    #[pyo3(name = "GetNormalized")]
    #[pyo3(signature = (eps=1e-10))]
    fn get_normalized(&self, eps: f64) -> Self {
        Self(self.0.normalized_with_eps(eps))
    }
    #[pyo3(name = "Normalize")]
    #[pyo3(signature = (eps=1e-10))]
    ...
    #[pyo3(name = "Transform")]
    fn transform(&self, p: &super::vec::PyVec3d) -> super::vec::PyVec3d {
    ...
    #[getter]
    fn real(&self) -> PyQuatd {
        PyQuatd(*self.0.real())
    }
    #[setter(real)]
    fn set_real_val(&mut self, q: &PyQuatd) {
        self.0.set_real(q.0);
    }
    #[getter]
    fn dual(&self) -> PyQuatd {
        PyQuatd(*self.0.dual())
    }
    #[setter(dual)]
    fn set_dual_val(&mut self, q: &PyQuatd) {
        self.0.set_dual(q.0);
    }
}
...
impl PyDualQuatf {
    ...
    fn new(
        ...
        let Some(r_obj) = real else {
            return Ok(Self(DualQuatf::identity()));
        };
        if let Ok(dq) = r_obj.extract::<pyo3::PyRef<'_, PyDualQuatf>>() {
            return Ok(Self(dq.0.clone()));
        }
        if let Ok(v) = r_obj.extract::<f32>() {
            ...
            if let Some(d_obj) = dual {
                if let Ok(d) = d_obj.extract::<pyo3::PyRef<'_, PyQuatf>>() {
                    dq.set_dual(d.0);
                }
            }
            return Ok(Self(dq));
        ...
        if let Ok(q) = r_obj.extract::<pyo3::PyRef<'_, PyQuatf>>() {
            ...
            if let Some(d_obj) = dual {
                if let Ok(d) = d_obj.extract::<pyo3::PyRef<'_, PyQuatf>>() {
                    dq.set_dual(d.0);
                } else if let Ok(v) = d_obj.extract::<pyo3::PyRef<'_, super::vec::PyVec3f>>() {
                    dq.set_translation(&v.0);
                }
            }
            return Ok(Self(dq));
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "DualQuatf: unsupported constructor",
        ))
    }

    fn __repr__(&self) -> String {
        format!(
            "Gf.DualQuatf(real={}, dual={})",
            self.0.real().real(),
            self.0.dual().real()
        )
    }
    ...
    fn __hash__(&self) -> u64 {
        ...
        let di = d.imaginary();
        let mut h = std::collections::hash_map::DefaultHasher::new();
        r.real().to_bits().hash(&mut h);
        ri.x.to_bits().hash(&mut h);
        ri.y.to_bits().hash(&mut h);
        ri.z.to_bits().hash(&mut h);
        d.real().to_bits().hash(&mut h);
        di.x.to_bits().hash(&mut h);
        di.y.to_bits().hash(&mut h);
        di.z.to_bits().hash(&mut h);
        h.finish()
    }
    ...
    #[pyo3(name = "GetIdentity")]
    fn get_identity() -> Self {
        Self(DualQuatf::identity())
    }

    #[pyo3(name = "GetReal")]
    fn get_real(&self) -> PyQuatf {
        PyQuatf(*self.0.real())
    }
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, q: &PyQuatf) {
        self.0.set_real(q.0);
    }
    #[pyo3(name = "GetDual")]
    fn get_dual(&self) -> PyQuatf {
        PyQuatf(*self.0.dual())
    }
    #[pyo3(name = "SetDual")]
    fn set_dual(&mut self, q: &PyQuatf) {
        self.0.set_dual(q.0);
    }
    #[pyo3(name = "GetLength")]
    fn get_length(&self) -> (f32, f32) {
        self.0.length()
    }
    #[pyo3(name = "GetNormalized")]
    ...
    #[pyo3(name = "SetTranslation")]
    fn set_translation(&mut self, t: &super::vec::PyVec3f) {
        self.0.set_translation(&t.0);
    }
    #[pyo3(name = "GetTranslation")]
    fn get_translation(&self) -> super::vec::PyVec3f {
        super::vec::PyVec3f(self.0.translation())
    }
    #[pyo3(name = "Transform")]
    fn transform(&self, p: &super::vec::PyVec3f) -> super::vec::PyVec3f {
    ...
    #[getter]
    fn real(&self) -> PyQuatf {
        PyQuatf(*self.0.real())
    }
    #[setter(real)]
    fn set_real_val(&mut self, q: &PyQuatf) {
        self.0.set_real(q.0);
    }
    #[getter]
    fn dual(&self) -> PyQuatf {
        PyQuatf(*self.0.dual())
    }
    #[setter(dual)]
    fn set_dual_val(&mut self, q: &PyQuatf) {
        self.0.set_dual(q.0);
    }
}
...
impl PyDualQuath {
    ...
    fn new(
        ...
        let Some(r_obj) = real else {
            return Ok(Self(DualQuath::identity()));
        };
        if let Ok(dq) = r_obj.extract::<pyo3::PyRef<'_, PyDualQuath>>() {
            return Ok(Self(dq.0.clone()));
        }
        if let Ok(v) = r_obj.extract::<f32>() {
            let q = Quath::from_components(
                Half::from_f32(v),
                Half::from_f32(0.0),
                Half::from_f32(0.0),
                Half::from_f32(0.0),
            ...
            if let Some(d_obj) = dual {
                if let Ok(d) = d_obj.extract::<pyo3::PyRef<'_, PyQuath>>() {
                    dq.set_dual(d.0);
                }
            }
            return Ok(Self(dq));
        ...
        Err(pyo3::exceptions::PyTypeError::new_err(
            "DualQuath: unsupported constructor",
        ))
    }

    fn __repr__(&self) -> String {
        format!(
            "Gf.DualQuath(real={}, dual={})",
            self.0.real().real().to_f32(),
            self.0.dual().real().to_f32()
        )
    }
    fn __str__(&self) -> String {
        self.__repr__()
    ...
    fn __hash__(&self) -> u64 {
        ...
        let di = d.imaginary();
        let mut h = std::collections::hash_map::DefaultHasher::new();
        r.real().bits().hash(&mut h);
        ri.x.bits().hash(&mut h);
        ri.y.bits().hash(&mut h);
        ri.z.bits().hash(&mut h);
        d.real().bits().hash(&mut h);
        di.x.bits().hash(&mut h);
        di.y.bits().hash(&mut h);
        di.z.bits().hash(&mut h);
        h.finish()
    }
    ...
    #[pyo3(name = "GetIdentity")]
    fn get_identity() -> Self {
        Self(DualQuath::identity())
    }

    #[pyo3(name = "GetReal")]
    fn get_real(&self) -> PyQuath {
        PyQuath(*self.0.real())
    }
    #[pyo3(name = "SetReal")]
    fn set_real(&mut self, q: &PyQuath) {
        self.0.set_real(q.0);
    }
    #[pyo3(name = "GetDual")]
    fn get_dual(&self) -> PyQuath {
        PyQuath(*self.0.dual())
    }
    #[pyo3(name = "SetDual")]
    fn set_dual(&mut self, q: &PyQuath) {
        self.0.set_dual(q.0);
    }
    #[pyo3(name = "GetLength")]
    fn get_length(&self) -> (f32, f32) {
    ...
    #[getter]
    fn real(&self) -> PyQuath {
        PyQuath(*self.0.real())
    }
    #[setter(real)]
    fn set_real_val(&mut self, q: &PyQuath) {
        self.0.set_real(q.0);
    }
    #[getter]
    fn dual(&self) -> PyQuath {
        PyQuath(*self.0.dual())
    }
    #[setter(dual)]
    fn set_dual_val(&mut self, q: &PyQuath) {
        self.0.set_dual(q.0);
    }
}
