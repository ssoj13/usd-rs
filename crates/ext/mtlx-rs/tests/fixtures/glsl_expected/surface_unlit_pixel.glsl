...
uniform vec3 in1;
uniform float surface_emission;
uniform float surface_transmission;
uniform vec3 surface_transmission_color;
...
mx_surface_unlit(surface_emission, in1, surface_transmission, surface_transmission_color, surface_opacity, surface_out);
    out1 = vec4(surface_out.color, 1.0);
}
