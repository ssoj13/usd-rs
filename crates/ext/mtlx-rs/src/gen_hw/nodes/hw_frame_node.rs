//! HwFrameNode — frame number uniform (по рефу HwFrameNode.cpp).
...
impl ShaderNodeImpl for HwFrameNode {
    ...
    fn emit_function_call(
        ...
        let line = format!("{} = {}", output.port.get_variable(), token::T_FRAME);
