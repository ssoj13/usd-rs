...
fn mix(
    ...
    *s0 = s0.wrapping_add(d[0]);
    *s2 ^= *s10;
    *s11 ^= *s0;
    *s0 = rot64(*s0, 11);
    *s11 = s11.wrapping_add(*s1);
    *s1 = s1.wrapping_add(d[1]);
    *s3 ^= *s11;
    *s0 ^= *s1;
    *s1 = rot64(*s1, 32);
    *s0 = s0.wrapping_add(*s2);
    *s2 = s2.wrapping_add(d[2]);
    *s4 ^= *s0;
    *s1 ^= *s2;
    *s2 = rot64(*s2, 43);
    *s1 = s1.wrapping_add(*s3);
    *s3 = s3.wrapping_add(d[3]);
    *s5 ^= *s1;
    *s2 ^= *s3;
    *s3 = rot64(*s3, 31);
    *s2 = s2.wrapping_add(*s4);
    *s4 = s4.wrapping_add(d[4]);
    *s6 ^= *s2;
    *s3 ^= *s4;
    *s4 = rot64(*s4, 17);
    *s3 = s3.wrapping_add(*s5);
    *s5 = s5.wrapping_add(d[5]);
    *s7 ^= *s3;
    *s4 ^= *s5;
    *s5 = rot64(*s5, 28);
    *s4 = s4.wrapping_add(*s6);
    *s6 = s6.wrapping_add(d[6]);
    *s8 ^= *s4;
    *s5 ^= *s6;
    *s6 = rot64(*s6, 39);
    *s5 = s5.wrapping_add(*s7);
    *s7 = s7.wrapping_add(d[7]);
    *s9 ^= *s5;
    *s6 ^= *s7;
    *s7 = rot64(*s7, 57);
    *s6 = s6.wrapping_add(*s8);
    *s8 = s8.wrapping_add(d[8]);
    *s10 ^= *s6;
    *s7 ^= *s8;
    *s8 = rot64(*s8, 55);
    *s7 = s7.wrapping_add(*s9);
    *s9 = s9.wrapping_add(d[9]);
    *s11 ^= *s7;
    *s8 ^= *s9;
    *s9 = rot64(*s9, 54);
    *s8 = s8.wrapping_add(*s10);
    *s10 = s10.wrapping_add(d[10]);
    *s0 ^= *s8;
    *s9 ^= *s10;
    *s10 = rot64(*s10, 22);
    *s9 = s9.wrapping_add(*s11);
    *s11 = s11.wrapping_add(d[11]);
    *s1 ^= *s9;
    *s10 ^= *s11;
    *s11 = rot64(*s11, 46);
    *s10 = s10.wrapping_add(*s0);
}
...
fn end_partial(
    ...
    *h11 = h11.wrapping_add(*h1);
    *h2 ^= *h11;
    *h1 = rot64(*h1, 44);
    *h0 = h0.wrapping_add(*h2);
    *h3 ^= *h0;
    *h2 = rot64(*h2, 15);
    *h1 = h1.wrapping_add(*h3);
    *h4 ^= *h1;
    *h3 = rot64(*h3, 34);
    *h2 = h2.wrapping_add(*h4);
    *h5 ^= *h2;
    *h4 = rot64(*h4, 21);
    *h3 = h3.wrapping_add(*h5);
    *h6 ^= *h3;
    *h5 = rot64(*h5, 38);
    *h4 = h4.wrapping_add(*h6);
    *h7 ^= *h4;
    *h6 = rot64(*h6, 33);
    *h5 = h5.wrapping_add(*h7);
    *h8 ^= *h5;
    *h7 = rot64(*h7, 10);
    *h6 = h6.wrapping_add(*h8);
    *h9 ^= *h6;
    *h8 = rot64(*h8, 13);
    *h7 = h7.wrapping_add(*h9);
    *h10 ^= *h7;
    *h9 = rot64(*h9, 38);
    *h8 = h8.wrapping_add(*h10);
    *h11 ^= *h8;
    *h10 = rot64(*h10, 53);
    *h9 = h9.wrapping_add(*h11);
    *h0 ^= *h9;
    *h11 = rot64(*h11, 42);
    *h10 = h10.wrapping_add(*h0);
    *h1 ^= *h10;
    *h0 = rot64(*h0, 54);
}
...
fn end(
    ...
    *h0 = h0.wrapping_add(d[0]);
    *h1 = h1.wrapping_add(d[1]);
    *h2 = h2.wrapping_add(d[2]);
    *h3 = h3.wrapping_add(d[3]);
    *h4 = h4.wrapping_add(d[4]);
    *h5 = h5.wrapping_add(d[5]);
    *h6 = h6.wrapping_add(d[6]);
    *h7 = h7.wrapping_add(d[7]);
    *h8 = h8.wrapping_add(d[8]);
    *h9 = h9.wrapping_add(d[9]);
    *h10 = h10.wrapping_add(d[10]);
    *h11 = h11.wrapping_add(d[11]);
...
fn spooky_short(message: &[u8], hash1: &mut u64, hash2: &mut u64) {
    ...
    let r = rem16;
    if r >= 15 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x00ff_ffff_ffff_ffff_u64);
    } else if r >= 14 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x0000_ffff_ffff_ffff_u64);
    } else if r >= 13 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x0000_00ff_ffff_ffff_u64);
    } else if r >= 12 {
        d = d.wrapping_add(read_u32(message, tail + 8));
        c = c.wrapping_add(read_u64(message, tail));
    } else if r >= 11 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x0000_0000_00ff_ffff_u64);
        c = c.wrapping_add(read_u64(message, tail));
    } else if r >= 10 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x0000_0000_0000_ffff_u64);
        c = c.wrapping_add(read_u64(message, tail));
    } else if r >= 9 {
        d = d.wrapping_add(read_u64(message, tail + 8) & 0x0000_0000_0000_00ff_u64);
        c = c.wrapping_add(read_u64(message, tail));
    } else if r >= 8 {
        c = c.wrapping_add(read_u64(message, tail));
    } else if r >= 7 {
        c = c.wrapping_add(read_u64(message, tail) & 0x00ff_ffff_ffff_ffff_u64);
    } else if r >= 6 {
        c = c.wrapping_add(read_u64(message, tail) & 0x0000_ffff_ffff_ffff_u64);
    } else if r >= 5 {
        c = c.wrapping_add(read_u64(message, tail) & 0x0000_00ff_ffff_ffff_u64);
    } else if r >= 4 {
        c = c.wrapping_add(read_u32(message, tail));
    } else if r >= 3 {
        c = c.wrapping_add(read_u64(message, tail) & 0x0000_0000_00ff_ffff_u64);
    } else if r >= 2 {
        c = c.wrapping_add(read_u64(message, tail) & 0x0000_0000_0000_ffff_u64);
    } else if r >= 1 {
        c = c.wrapping_add(read_u64(message, tail) & 0x0000_0000_0000_00ff_u64);
    } else {
...
fn spooky_hash128(message: &[u8], seed1: u64, seed2: u64) -> (u64, u64) {
    ...
    for block in 0..num_blocks {
        ...
        mix(
            &d, &mut h0, &mut h1, &mut h2, &mut h3, &mut h4, &mut h5, &mut h6, &mut h7, &mut h8,
            &mut h9, &mut h10, &mut h11,
        );
    }
