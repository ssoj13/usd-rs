...
pub fn eval_box_spline_tri_deriv_weights(m: &[f32; 15], ds: i32, dt: i32, w: &mut [f32; 12]) {
    ...
    match total {
        0 => {
            let s = 1.0_f32 / 12.0;
            w[0] = s
                * (1.0 - 2.0 * m[1] - 4.0 * m[2] + 6.0 * m[4] + 6.0 * m[5] + 2.0 * m[6]
                    - 6.0 * m[8]
                    - 4.0 * m[9]
                    - m[10]
                    - 2.0 * m[11]
                    ...
                    + m[14]);
            w[1] = s
                * (1.0 + 2.0 * m[1] - 2.0 * m[2] - 6.0 * m[4] - 4.0 * m[6]
                    + 6.0 * m[8]
                    + 2.0 * m[9]
                    + 2.0 * m[10]
                    + 4.0 * m[11]
            ...
            w[3] = s
                * (1.0 - 4.0 * m[1] - 2.0 * m[2] + 6.0 * m[3] + 6.0 * m[4]
                    - 4.0 * m[6]
                    - 6.0 * m[7]
                    + 2.0 * m[9]
                    + m[10]
                    ...
                    - m[14]);
            w[4] = s
                * (6.0 - 12.0 * m[3] - 12.0 * m[4] - 12.0 * m[5]
                    + 8.0 * m[6]
                    + 12.0 * m[7]
                    + 12.0 * m[8]
                    + 8.0 * m[9]
            ...
            w[6] = s * (m[10] + 2.0 * m[11]);
            w[7] = s
                * (1.0 - 2.0 * m[1] + 2.0 * m[2] - 6.0 * m[4] + 2.0 * m[6] + 6.0 * m[7]
                    - 4.0 * m[9]
                    - m[10]
                    - 2.0 * m[11]
                    + 4.0 * m[13]
                    + 2.0 * m[14]);
            w[8] = s
                * (1.0 + 2.0 * m[1] + 4.0 * m[2] + 6.0 * m[4] + 6.0 * m[5]
                    - 4.0 * m[6]
                    - 12.0 * m[7]
                    - 6.0 * m[8]
                    - 4.0 * m[9]
                    ...
                    - m[14]);
            w[9] = s
                * (2.0 * m[6] + 6.0 * m[7] + 6.0 * m[8] + 2.0 * m[9]
                    - m[10]
                    - 2.0 * m[11]
                    - 2.0 * m[13]
                    - m[14]);
        ...
        1 if ds != 0 => {
            let s = 1.0_f32 / 6.0;
            w[0] =
                s * (-1.0 + 3.0 * m[2] + 3.0 * m[3] - 3.0 * m[5] - 2.0 * m[6] - 3.0 * m[7] + m[9]);
            w[1] =
                s * (1.0 - 3.0 * m[2] - 6.0 * m[3] + 3.0 * m[5] + 4.0 * m[6] + 6.0 * m[7] - m[9]);
            w[2] = s * (3.0 * m[3] - 2.0 * m[6] - 3.0 * m[7]);
            w[3] = s
                * (-2.0 + 6.0 * m[1] + 3.0 * m[2] - 6.0 * m[3] - 6.0 * m[4]
                    + 2.0 * m[6]
                    + 3.0 * m[7]
                    - m[9]);
            w[4] = s
                * (-12.0 * m[1] - 6.0 * m[2] + 12.0 * m[3] + 12.0 * m[4] + 6.0 * m[5]
                    - 2.0 * m[6]
                    - 3.0 * m[7]
                    - m[9]);
            w[5] = s
            ...
            w[7] = s
                * (-1.0 - 3.0 * m[2] + 3.0 * m[3] + 6.0 * m[4] - 2.0 * m[6] - 3.0 * m[7]
                    + 2.0 * m[9]);
            w[8] = s
                * (1.0 + 3.0 * m[2] - 6.0 * m[3] - 12.0 * m[4] - 3.0 * m[5]
                    + 4.0 * m[6]
                    + 6.0 * m[7]
                    - m[9]);
        ...
        1 => {
            ...
            let s = 1.0_f32 / 6.0;
            w[0] = s
                * (-2.0 + 3.0 * m[1] + 6.0 * m[2] - 6.0 * m[4] - 6.0 * m[5] - m[6]
                    + 3.0 * m[8]
                    + 2.0 * m[9]);
            w[1] = s
                * (-1.0 - 3.0 * m[1] + 6.0 * m[4] + 3.0 * m[5] + 2.0 * m[6]
                    - 3.0 * m[8]
                    - 2.0 * m[9]);
            w[2] = s * (-m[6]);
            w[3] =
                s * (-1.0 + 3.0 * m[1] - 3.0 * m[3] + 3.0 * m[5] + m[6] - 3.0 * m[8] - 2.0 * m[9]);
            w[4] = s
                * (-6.0 * m[1] - 12.0 * m[2] + 6.0 * m[3] + 12.0 * m[4] + 12.0 * m[5]
                    - m[6]
                    - 3.0 * m[8]
                    - 2.0 * m[9]);
            w[5] = s
                * (1.0 + 3.0 * m[1] - 3.0 * m[3] - 12.0 * m[4] - 6.0 * m[5] - m[6]
                    + 6.0 * m[8]
                    + 4.0 * m[9]);
            w[6] = s * (m[6]);
            w[7] =
                s * (1.0 - 3.0 * m[1] + 3.0 * m[3] - 6.0 * m[5] - m[6] + 6.0 * m[8] + 4.0 * m[9]);
            w[8] = s
                * (2.0 + 3.0 * m[1] + 6.0 * m[2] - 6.0 * m[3] - 6.0 * m[4] - 6.0 * m[5]
                    + 2.0 * m[6]
                    - 3.0 * m[8]
                    - 2.0 * m[9]);
